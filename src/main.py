...
parser.add_argument('--cg_weight', type=float, default=2, help='weight of cycle gan')
...
parser.add_argument('--l2_weight', type=float, default=1e-6, help='weight of l2 regularization')
parser.add_argument('--lr_rs', type=float, default=1e-4, help='learning rate of RS task')

...
parser.add_argument('--lr', type=float, default=0.01, help='learning rate of KGE task')
parser.add_argument('--kg_weight', type=float, default=0.2, help='learning rate of KGE task')
...
outputfile = open("logs/log_book.txt","a")
sys.stdout = outputfile

args = parser.parse_args()
data = load_data(args)

print("++++++ Training On lr=" + str(args.lr) + ' and kg_weight=' + str(args.kg_weight) + ": +++++++")
